...
public class EjecutaEmpleado {
    ...
    public static void main(String[] args) {
        ...
        double sueldoMen, sueldoQAdm,valorTrab,sueldoQMe,salarioMin,sueldoQVen;
        int veces,cantidad,opc2;
        boolean opcion = true;
        int tipoEmpleado = 0;
        ...
        while (opcion == true){
            ...
            if (tipoEmpleado == 1){
                ...
                sueldoMen = entrada.nextDouble();

                Administrativos administrativos = new Administrativos(sueldoMen);
