package HerenciaPrestamo;

import java.util.Scanner;

public class EjecutaPrestamo {
    public static void main(String[] args) {
        Scanner entrada = new Scanner(System.in);

        String numeroCliente,nombre,numeroCuenta;
        double capital, tasaInteres,interes;
        int plazo;
        boolean opcion = true;
        int tipoDeuda = 0;
        int contadorClientes = 0, opc2;
        String cadena = "";
